 ...
 *
 */
public class InsertionSortPartSecond {
    ...
    static void printInsertionSortStages(int[] array) {
        for (int indexToSort = 1; indexToSort < array.length; indexToSort++) {
            int indexOfSortableElement = indexToSort;
            int sortedValue = array[indexToSort];
            int[] shifted = array;
